<?php
			...
			<div class="px-50-no w-100">
				...
				<div>
						...
						<div class="topic-content-area">
							...
							?>
							<div class="fs-20 fw-600 mt-24 ps-15">
							...
							<?php if($my_query2->max_num_pages > 1){ ?>
								<div class="mt-50 ps-15">
									<a href="<?= $permalink; ?>" class="fw-600 hover-orange" style="padding-left: 16px;margin-top:24px; color: #EA543F;padding-right:8px;display:block;">
										Learn More 
										<span>
											<svg width="16" height="10" viewBox="0 0 16 10" fill="none" xmlns="http://www.w3.org/2000/svg">
												<path d="M12.25 3.75H0.5V5.41667H12.25L9.66667 8L10.8333 9.16667L15.4167 4.58333L10.9167 0L9.75 1.16667L12.25 3.75Z" fill="#EA543F"></path>
											</svg>
										</span>
									</a>
								</div>
	...
	// register shortcode
	add_shortcode('help-topic-content', 'help_topic_content');
?>