    ...
    <div id="quizPopup" class="cq-popup hidden">
      <div class="cobra-close" onclick="closeQuiz()">
        ...
        <div class="cq-screen hidden" id="emailScreen" style="background-image: url(https://www.rapiddirect.com/wp-content/uploads/2025/12/cristmas-1-scaled.jpg); background-size: cover;background-position: center;">
          <div class="text-white seems-h2">Christmas Quiz Challenge Precision-Unlocked Rewards</div>
          ...
          <div class="even-rules-cristmas">
            <div class="seems-h4">Event Rules</div>
            <ul>
              ...
              <li>Event Period: Dec 12, 2025 — Dec 29, 2025</li>
            </ul>
          </div>
        ...
        <div class="cq-screen hidden" id="quizScreen" style="background-image: url(https://www.rapiddirect.com/wp-content/uploads/2025/12/christmas-2-scaled.jpg); background-size: cover;background-position: center;">
          <div class="questions-all">
            ...
            <div id="qText" class="seems-h3">Question here</div>
        ...
        <div class="cq-screen hidden" id="resultScreen"  style="background-image: url(https://www.rapiddirect.com/wp-content/uploads/2025/12/cristmas-3-scaled.jpg); background-size: cover;background-position: center;">
          <div class="text-white seems-h2">Challenge Complete! Your Precision Report is Ready</div>
          <div class="text-white"  id="accuracyScore-text">Accuracy Score</div>
          <div id="accuracyScore" class="text-white seems-h1">0</div>
...
// Prize logic
const prizes = [
  { score: 100, img: "https://www.rapiddirect.com/wp-content/uploads/2025/12/award-1.png", text: "Thermal Bottle", code: "RoT-x9F7-42ok", probability: 50, quantity: 2, form_type:"营销订阅", form_name:"2025年圣诞节礼物 - 不锈钢水杯" },
  { score: 80,  img: "https://www.rapiddirect.com/wp-content/uploads/2025/12/award-2.png", text: "Notebook", code: "RON8-730-P9Lx", probability: 50, quantity: 2, form_type:"营销订阅", form_name:"2025年圣诞节礼物 - 笔记本" },
  { score: 60,  img: "https://www.rapiddirect.com/wp-content/uploads/2025/12/award-3.png", text: "15% OFF Coupon <br>(Up to $500)", code: "RD15-X9F7Q2LM", probability: 0, quantity: 0 },
  { score: 40,  img: "https://www.rapiddirect.com/wp-content/uploads/2025/12/award-4.png", text: "Free Shipping <br>(Up to $200)", code: "RDSHIP-Q6TM9F2L", probability: 0, quantity: 0 }
];
...
//   }
	...
	function closeChrisGudda() {
		const elem = document.getElementById("christmas-icon-rd-id");
		if (!elem) return;
		...
		localStorage.setItem("chrisGuddaHiddenUntil-2", expiresAt);
	}
	function initChrisGudda() {
		const elem = document.getElementById("christmas-icon-rd-id");
		if (!elem) return;

		const hiddenUntil = localStorage.getItem("chrisGuddaHiddenUntil-2");

		if (hiddenUntil && Date.now() < Number(hiddenUntil)) {
			// Still in hidden period → keep hidden
			elem.classList.add("hidden");
		} else {
			// Clear old value and show icon
			localStorage.removeItem("chrisGuddaHiddenUntil"-2);
			elem.classList.remove("hidden");
		}
	}
	// Call on page load
	document.addEventListener("DOMContentLoaded", initChrisGudda);

	function watchForWheelButton() {
		const observer = new MutationObserver(() => {
			const btn = document.getElementById('open-cristmas-id');
			if (btn) {
	...
	// register shortcode
	add_shortcode('christmas', 'display_christmas');
