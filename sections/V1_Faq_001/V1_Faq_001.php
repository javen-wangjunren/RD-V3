...
/*
<?php mtf_section('V1_Faq_001', 'faq_001', [
	'item_color' => '#333',
	'item_bgcolor' => '#fff',
	'item_question_color' => '#333',
	'item_question_color_active' => '#0095eb',
	'item_answer_icon_color' => '#03a67b',
	'class' => '',
	'bg_color' => '#fff',
	'bg_image' => '',
	'margin_top' => '',
...
class V1_Faq_001  extends MML_Section_Base {
	...
	public function set_default_value () {
		...
		$this->set_default_style('item_question_color_active', '#0095eb');
		$this->set_default_style('item_answer_icon_color', '#03a67b');
	...
	public function style () {
		?>
			...
			.<?php $this->eid(); ?> .m-faq-item {
			  ...
			  -webkit-box-shadow: 0px 5px 21px 0px rgba(50, 48, 34, 0.18);
			          box-shadow: 0px 5px 21px 0px rgba(50, 48, 34, 0.18);
			...
			.<?php $this->eid(); ?> .m-faq-item.active .m-faq-item-hd {
				<?php $this->css_attr_color('item_question_color_active'); ?>
			}

			.<?php $this->eid(); ?> .m-faq-item.active .m-faq-item-hd i {
			...
			.<?php $this->eid(); ?> .m-faq-item .m-faq-item-bd i {
			  ...
			  -webkit-border-radius: 100%;
			          border-radius: 100%;
				<?php $this->css_attr('background-color', 'item_answer_icon_color'); ?>
			}
