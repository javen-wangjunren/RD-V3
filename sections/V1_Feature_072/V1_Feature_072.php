...
class V1_Feature_072  extends MML_Section_Base {
...
(function($){
	$(document).ready(function(){
		...
		var mySwiper = new Swiper('.<?php $this->eid(); ?> .swiper-container', {
			autoplay: true,
			slidesPerView : 3,
			slidesPerGroup : 1,
			mousewheel: true,
			...
			<div class="<?php $this->echo_default_classes(); ?>">
				<div class="container">
					...
					<div class="cat-main">
						<div class="blk">
							<div class="tit">
								<h4>Feature Name 1</h4>
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean euismod bibendum laoreet. Proin gravida dolor sit amet lacus accumsan et viverra justo commodo.</p>
							</div>
							<div class="slicker swiper-container">
