...
class V2_Banner_001  extends MML_Section_Base {
		...
		?>
			<div class="<?php $this->echo_default_classes(); ?>">
				...
				<div class="content" style="background: url('https://via.placeholder.com/1920x755/eee') no-repeat;">
					<div class="mml-text">
						<b class="pre-heading">MML Rocks</b>
				...
				<ul class="list">
					<li>
						...
						<h3>Heading 3</h3>
						<p>Strict supplier monitoring ensures that the trailer parts you get are of the same high quality.</p>
					</li>
					<li>
						<i class="fas fa-check"></i>
						<h3>Heading 3</h3>
