...
class V1_Feature_003  extends MML_Section_Base
{
		...
		<div class="<?php $this->echo_default_classes(); ?>">
			...
			<div class="container">
				...
				<div class="right-wrap">
					<div class="text-wrap">
						<p>“We help Saas companies find their voice, grow the ARR monster and scale internationally.”</p>
						<div class="man">
							<i class="fas fa-check-circle"></i>
							<span>Ben Tompson</span>
						</div>
					</div>
