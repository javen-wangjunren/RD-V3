<section class="elementor-section elementor-section-boxed px-2">
	<div class="elementor-container elementor-column-gap-default align-start">
		<div class="elementor-column elementor-col-30 w-100 pe-100">
			<div class="w-100">
				...
				<div class="mt-24 side-ques <?php if($cuurentID == get_the_ID()){ echo 'activee'; }?> <?php if(get_field('is_important_topic')){ echo 'star-article'; }?>">
					<a href="<?= the_permalink();?>" class="d-flex-btw-ctr align-start justify-start">
		...
		<div class="elementor-column elementor-col-70 w-100">
			<div class="px-50 py-50 border-1px border-color-d0 w-100">
				<h1 class="fs-36">
					<?= the_title();?>
				</h1>
				<?php if (have_posts()) :
					...
					<article>
						<div class="help-center-body font-16 mt-24">
							<?php the_content(); ?>
						</div>
					</article>
					<?php endwhile;?>
					<div class="reaction">
						<div class="mt-50">
							<?php include_once "_reaction.php" ?>
						</div>
					</div>
				<?php endif; ?>
			</div>
